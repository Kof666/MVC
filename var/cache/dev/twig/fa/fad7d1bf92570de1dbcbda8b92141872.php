...
/* pig/home.html.twig */
class __TwigTemplate_333b58e4491c4dae6d1500092ce7ede4 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"pig\">
    ...
    <button class=\"button\" role=\"button\">
        <a href=\"{{ path('pig_init_get')}}\">Play Game</a>
    </button>
</div>

<a href=\"{{path('test_roll_dice')}}\">check roll dice</a>
<a href=\"{{path('test_roll_num_dice', {num: 5})}}\">check roll many dices</a>

{% endblock %}
", "pig/home.html.twig", "/home/kb/dbwebb-kurser/mvc/me/report/templates/pig/home.html.twig");
    }
}
