...
class CardGameController extends AbstractController
{
     ...
     */
    #[Route("/game/card/test", name: "test_card")]
    public function testCard(): Response
    {
        ...
        $card = new Card();
        $card->setCard('spader A');

        $data = [
            "card" => $card->getAsString()
        ];

        return $this->render('card/test/test_card.html.twig', $data);
    }
